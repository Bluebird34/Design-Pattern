...
public class Avion_F16_White extends Avion implements Couleur{
    @Override
    ...
    public void getAvionRepresentation() {
        System.out.println("Construction Avion F16 white terminé");
    }

    @Override
    public void paint() {
        System.out.println("Paint Avion F16 coleur terminé, coloeur : " + couleur_1);
    }
}
